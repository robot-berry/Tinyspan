...
- X2 训练：epoch `29`，step `114373/198000`。
...
| X2 X2 独立证据包 | `PARTIAL` | X2 正式训练运行中；epoch `29`，step `114373/198000`，progress `57.7641%`。 | 训练完成后冻结、量化、导出 RTL、生成 bitstream 并上板验证。 |
