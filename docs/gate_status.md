...
- X2 训练：epoch `31`，step `119465/198000`。
...
| X2 X2 独立证据包 | `PARTIAL` | X2 正式训练运行中；epoch `31`，step `119465/198000`，progress `60.3359%`。 | 训练完成后冻结、量化、导出 RTL、生成 bitstream 并上板验证。 |
