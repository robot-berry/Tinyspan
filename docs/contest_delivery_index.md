...
生成时间：`2026-06-25T12:21:21`
索引生成前提交：`5b965dc71b16853175c4f5450e40047a5ea747b2`
总体状态：`NOT_COMPLETE`
...
- X2 训练：`training_running`，epoch `32`，step `123931/198000`，progress `62.5914%`。
...
- `PASS` `README.md`，3014 bytes，SHA256 `0976E119B5B5FCE788A662A7CCEE46B9982CA145797A2333746AEDC64BA73C4C`
- `PASS` `WORKFLOW.md`，48198 bytes，SHA256 `115B9B21A42DC45EA1A532FF797C0A110DEC48AEBA0CB9B148DA534A23B9F699`
- `PASS` `docs/gate_status.md`，3188 bytes，SHA256 `3EF15B0C64ACAEA4D274936FD9261720D6C1F88AEBD1331E98230909FF7154C4`
- `PASS` `docs/contest_delivery_audit.md`，5981 bytes，SHA256 `1CB814DC143D3E2EB45CB163ED2419E53DB9955C44CD0164EC799AB285DD6E76`
- `PASS` `docs/x2_hardware_readiness.md`，2558 bytes，SHA256 `7210FBBD89E8A6AB04C9784F2A1A44DBCEF77009FCE37C8C183CF24762C3428C`
- `PASS` `artifacts/20260618_x4_tinyspan_c32b4_baseline_30fps_safe/contest_completion_status.json`，3566 bytes，SHA256 `519091ED674A4303AEA99907F0AE6A15138457212634F14677A1858721B95A9E`
- `PASS` `artifacts/20260618_x4_tinyspan_c32b4_baseline_30fps_safe/contest_delivery_audit.json`，10572 bytes，SHA256 `63E34C3BBED490B5D018BBEF7D1C691B02CED198CD99698884846EAFB85076CA`
- `PASS` `artifacts/20260618_x4_tinyspan_c32b4_baseline_30fps_safe/x2_hardware_readiness.json`，3498 bytes，SHA256 `C944A71BE315F861A7A7D7938DEAC2BF8A034A2A36BBDEB6082766B5B3C9DEFA`
...
- `PASS` `docs/x4_board_result_report_20260625.md`，4395 bytes，SHA256 `9BC6CB3976FC63D2F661B3BE13CA2F709277741AFBAAAB5940075803EC1B2F5D`
- `PASS` `docs/x4_quality_improvement_plan.md`，5941 bytes，SHA256 `D4F7A5FC46F61BAF7FD4091844FE011986AF2750442090D4A4E5824798537EBA`
