...
生成时间：`2026-06-25T12:52:10`
索引生成前提交：`de4acc53ef7107c67846debad6e2b6e081ef95d0`
总体状态：`NOT_COMPLETE`
...
- X2 训练：`training_running`，epoch `32`，step `126621/198000`，progress `63.95%`。
...
- `PASS` `docs/gate_status.md`，3186 bytes，SHA256 `25FA465526946F4E17E6D35D6C9356B45F41F181C39100EE917137F22EA48D55`
- `PASS` `docs/contest_delivery_audit.md`，5981 bytes，SHA256 `C7931121F8F0328B4EA536A9CAF05ED1D5409B61E7DAE48272B3B110A7388175`
- `PASS` `docs/x2_hardware_readiness.md`，4978 bytes，SHA256 `CAA30DC0BD2A41E7B58F977ECE2DFE9279665369E687DDB8C98F935AC7DFDF1B`
- `PASS` `artifacts/20260618_x4_tinyspan_c32b4_baseline_30fps_safe/contest_completion_status.json`，3564 bytes，SHA256 `AC5D75758EA9B5FCF7F2E6ED44627234FC8A8788C0368D2FAA4F7928C46CF808`
- `PASS` `artifacts/20260618_x4_tinyspan_c32b4_baseline_30fps_safe/contest_delivery_audit.json`，10572 bytes，SHA256 `6FA82E233F5FD01C1870CEFEE30DC0E4B879AFC48B49F92652CCF5C27764CDD7`
- `PASS` `artifacts/20260618_x4_tinyspan_c32b4_baseline_30fps_safe/x2_hardware_readiness.json`，6325 bytes，SHA256 `B5EA5ED32EA4EA263C7309A6EDB0D7177972D0D6B27E7ECE05DC98D38F8B0040`
...
- `PASS` `scripts/run_tinyspan_c32b4_post_training_prep.ps1`，5977 bytes，SHA256 `B6A6D441FDB8D3E7ABE489DBD252B777632BBC2885D8DF9A4C21D4504A0C80F9`
